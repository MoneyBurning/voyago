...
/**
 * 결과 화면의 실제 콘텐츠. sessionStorage(voyago_result/voyago_input)에 저장된
 * 데이터로 렌더링하므로 클라이언트 전용이다 — SNS 크롤러가 보는 og:title 등의
 * 동적 메타데이터는 여기서 만들 수 없어 app/result/page.tsx(서버 컴포넌트)의
 * generateMetadata가 URL 쿼리스트링으로 별도 처리한다.
 */
